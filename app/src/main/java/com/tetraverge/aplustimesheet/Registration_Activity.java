...
public class Registration_Activity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(Registration_Activity.this,"Congratulation" +
                                ...
                                Toast.makeText(Registration_Activity.this,"Error  "+erroremassage,
    ...
    private void saveAccountInfoinDatabase() {
        ...
        {
            Toast.makeText(Registration_Activity.this,"Please Enter Your Name", Toast.LENGTH_LONG).show();
        }
            ...
            userRef.child(currentUserId).updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    ...
                    if (task.isSuccessful())
                    {
                        loadingbar.dismiss();
                        sendusertoMainActivity();
                        Toast.makeText(Registration_Activity.this,"Profile Setup Successful", Toast.LENGTH_LONG).show();
                    }
                    else {
                        loadingbar.dismiss();

                        String exceptioMassage = task.getException().getMessage();
                        Toast.makeText(Registration_Activity.this,"Error "+ exceptioMassage, Toast.LENGTH_LONG).show();
